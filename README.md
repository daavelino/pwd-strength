...
1. mathematically, **the majority of those most used passwords have good entropy!**. The problem is that they became somehow guessable and that's what we should help to solve. Enabling ordinary people to create good passwords.
